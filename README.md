...
<p align="center">
  <img src="docs/assets/Screenshot%20MAESTRO_Dashboard.jpg" alt="Maestro AI Dashboard" width="600">
</p>
<p align="center"><i>Maestro AI: Unified dashboard for label, studio, and live operations</i></p>
...
<img src="docs/assets/agent_roster_carousel_updated.png" alt="Agent Roster" width="600">
...
<img src="docs/assets/service_tiers_static.png" alt="Service Tiers" width="600">
...
<img src="docs/assets/MAESTRO_Run_Agents.jpg" alt="Run Agents" width="400">
...
#### Dashboard
<img src="docs/assets/Screenshot%20Departments.jpg" alt="Departments" width="400">

#### Live Agent Example
<img src="docs/assets/LIVE_Dashboard.jpg" alt="Live Dashboard" width="400">
...
- [x] v1.4.0: Multi-agent orchestration, CEO Command Centre, live dashboard
- [ ] Advanced analytics & reporting
- [ ] Plugin/extension API for custom agents
- [ ] Docker deployment & SaaS onboarding
- [ ] More agent types (LEDGER, FOCUS, etc.)
...
---
>>>>>>> 93ef9cd (Update documentation and add new markdown files)
