...
- **Run Agents:** Directly run any agent (e.g., VINYL, ECHO, BRIDGE, SAGE) or the full pipeline for granular control and testing.
- **CrewAI Integration:** Modular, role-based agent orchestration with CrewAI, easily extended for any business domain.
