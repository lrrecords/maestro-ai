Method Map  
This table maps the most common long-running coding-agent failure modes to the artifact or operating rule that usually fixes them first. All referenced artifacts are present and maintained in the maestro-ai repository.
...
_Reminder: Update these artifacts as part of the end-of-session checklist to ensure smooth handoff and reliability._