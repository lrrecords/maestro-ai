...
I will send your token in a separate message.

Please test:
- Login
- /hub loads
- /agents loads
- Run one workflow and share your impression
```
...
I will send your login token in a separate secure message.
...
- Use the onboarding runbook for guided sessions: docs/LIVE_USER_ONBOARDING.md
