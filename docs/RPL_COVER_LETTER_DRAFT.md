...
- [docs/RPL_ICT40120_MAESTRO_OVERVIEW.md](RPL_ICT40120_MAESTRO_OVERVIEW.md)
- [docs/RPL_ICT40120_EVIDENCE_INDEX.md](RPL_ICT40120_EVIDENCE_INDEX.md)
...
Assessment framing:
- I am seeking recognition for competence already demonstrated in real work, not asking the qualification to be awarded without evidence.
- The evidence pack is organized to support a fair and efficient assessor review.
