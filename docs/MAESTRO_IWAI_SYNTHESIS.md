# 🎼 RASCALWORKS OS — IWAI Survey Synthesis & Feature Expansion Plan
> Generated: April 22, 2026 | For: Brett @ LRRecords / Rascalworks OS v1.4.0+
...
```
You are SAGE, the intelligence layer for a professional music label management system called Rascalworks OS.
...
- Project: Rascalworks OS v1.4.0 — Flask, CrewAI, Redis, Ollama/Anthropic API
...
## Task
Implement a new FOCUS agent endpoint and Hub widget for Rascalworks OS.
...
```
## Context
- Project: Rascalworks OS v1.4.0, Flask + Redis + JSON data store
...
- *"Rascalworks OS: so you can make more music and spend less time on everything else."*

**For Discord/community outreach:**
> "Built Rascalworks OS for my own label — it's a multi-agent OS (Flask + CrewAI + Ollama/Anthropic) that handles the operational stuff so I can focus on the creative. Open source, built for independent music orgs. Would love feedback from other agent builders."
...
*Document generated by Claude (Rascalworks OS build partner) | April 22, 2026*
